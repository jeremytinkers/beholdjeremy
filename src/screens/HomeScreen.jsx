        ...
        <div className="aboutMe">
          ...
          <div id="aboutPara">
            <p>
              ...
              dunes, behold another culturally bewildered{" "}
              <strong id="cok">
                <div class="tooltipCard">
                  <a
                    href="https://www.google.com/search?q=kerala&rlz=1C1JZAP_enIN878IN878&oq=kerala&aqs=chrome.0.69i59j46i67i433j0i67i131i433l2j46i131i433i512j0i20i131i263i433i512j0i131i433i512j46i175i199i512j0i3l2.3048j0j7&sourceid=chrome&ie=UTF-8"
                    target="_blank"
                  >
                    {" "}
                    മലയാളി
            ...
            <p>
              I like to be called Jeremy and am currently a{" "}
              <strong>3rd year CS Undergrad</strong> at{" "}
              <a href="https://www.nitt.edu/" target="_blank">
                <strong>NIT-T</strong>
              </a>{" "}
              with a deep passion for building products with the user in focus.
            </p>

            {/* <p>In addition, startups, tech, stocks and marketing get my adrenaline pumping!</p> */}

            <p>
              I'm currently on the lookout for <strong>internships</strong> in
              the <strong>SWE/PM</strong> space(preferably startups){" "}
            </p>
          </div>
        </div>
      </div>
